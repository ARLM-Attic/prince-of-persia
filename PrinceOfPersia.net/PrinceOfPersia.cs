...
namespace PrinceOfPersia
{
    ...
    public class PrinceOfPersiaGame : GameScreen
    {
        ...
        {
            Vector2 hudLocation = new Vector2(0, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - Room.BOTTOM_BORDER);

            //DRAW BLACK SQUARE
            Rectangle r = new Rectangle(0, 0, PrinceOfPersiaGame.CONFIG_SCREEN_WIDTH, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT);
            ...
            //check if death
            hudLocation = new Vector2(PrinceOfPersiaGame.CONFIG_SCREEN_WIDTH / 3, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - Room.BOTTOM_BORDER);
            if (maze.player.IsAlive == false)
            {
            ...
            {
                hudLocation = new Vector2(0 + offset, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - Room.BOTTOM_BORDER);
                        ...
                        case "Guard":
                            {
                                ...
                                for (int x = 1; x <= maze.player.LivePoints; x++)
                                {
                                    hudLocation = new Vector2(PrinceOfPersiaGame.CONFIG_SCREEN_WIDTH - offset, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - Room.BOTTOM_BORDER);
        ...
        private void DrawDebug(Room room)
        {
            ...
            for (int y = (int)v4.Z; y <= (int)v4.W; ++y)
            {
                for (int x = (int)v4.X; x <= (int)v4.Y; ++x)
                {
                    ...
                    hudLocation.Y = hudLocation.Y + 10;
                    DrawShadowedString(fontPrinceOfPersia_bigger, "GRID X=" + x + " Y=" + y + " TILETYPE=" + tileType.ToString() + " BOUND X=" + tileBounds.X + " Y=" + tileBounds.Y + " DEPTH X=" + depth.X + " Y=" + depth.Y, hudLocation, Color.White);
                }
            }
        }
        ...
        {
            if (PrinceOfPersiaGame.CONFIG_TOUCHSCREEN_VISIBLE == false)
                return;
            ...
            CntDownLeftZone = new Rectangle(texControl.Width * 0, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - (texControl.Height * 1), texControl.Width, texControl.Height);
            CntDownZone = new Rectangle(texControl.Width * 1, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - (texControl.Height * 1), texControl.Width, texControl.Height);
            CntDownRightZone = new Rectangle(texControl.Width * 2, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - (texControl.Height * 1), texControl.Width, texControl.Height);

            CntLeftZone = new Rectangle(texControl.Width * 0, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - (texControl.Height * 2), texControl.Width, texControl.Height);
            CntCenterZone = new Rectangle(texControl.Width * 1, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - (texControl.Height * 2), texControl.Width, texControl.Height);
            CntRightZone = new Rectangle(texControl.Width * 2, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - (texControl.Height * 2), texControl.Width, texControl.Height);

            CntUpLeftZone = new Rectangle(texControl.Width * 0, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - (texControl.Height * 3), texControl.Width, texControl.Height);
            CntUpZone = new Rectangle(texControl.Width * 1, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - (texControl.Height * 3), texControl.Width, texControl.Height);
            CntUpRightZone = new Rectangle(texControl.Width * 2, PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - (texControl.Height * 3), texControl.Width, texControl.Height);

            CntShiftZone = new Rectangle(PrinceOfPersiaGame.CONFIG_SCREEN_WIDTH - (texControlButton.Width * 2), PrinceOfPersiaGame.CONFIG_SCREEN_HEIGHT - (texControlButton.Height * 2), texControl.Width, texControlButton.Height);
