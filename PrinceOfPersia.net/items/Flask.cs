...
namespace PrinceOfPersia
{
    public class Flask : Item
    {
        public Flask(ContentManager Content)
        {
            ...
            Stream txtReader = Microsoft.Xna.Framework.TitleContainer.OpenStream(PrinceOfPersiaGame.CONFIG_PATH_CONTENT + PrinceOfPersiaGame.CONFIG_PATH_SEQUENCES + Enumeration.Items.flask.ToString() + "_sequence.xml");
