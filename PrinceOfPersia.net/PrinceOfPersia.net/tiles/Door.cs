...
namespace PrinceOfPersia
{
    class Door : Tile
    {
        ...
        public Door(RoomNew room, ContentManager Content, Enumeration.TileType tileType, Enumeration.StateTile state, int switchButton, Enumeration.TileType NextTileType)
        {
